...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    List<Student> findStudentsByDepartmentId(@Param("departmentId") Long departmentId); // Find students by departmentDTO
    ...
    @Query("SELECT COUNT(s) FROM Student s WHERE s.department = :departmentDTO")
    long countStudentsByDepartment(@Param("departmentDTO") Department department); // Count students by departmentDTO
